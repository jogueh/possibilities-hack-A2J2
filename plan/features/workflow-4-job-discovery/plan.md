...
- **W4 owns `src/lib/scoring.ts`** (the shared scoring engine, pure functions). It replaced main's labeled MOCK; W2 imports it for the seed web. Do **not** invent a parallel scoring system.
