...
export function ActionsBar({
  ...
  return (
    <section style={{ marginTop: 24, paddingTop: 16, borderTop: `1px solid ${LI.border}` }}>
      ...
      {/* Connecting now implicitly pins the person to the canvas (the old
          "Add to web" button was redundant — the viewer almost always wants
          a connected person to stay visible across branch switches), so
          there's no separate pin UI here anymore. */}
